...
Part 6은 실제 vault 분석이다. [[16_work_vault_case_analysis|work_vault 사례 분석]]에서 개인 개발자가 직접 만든 작업 vault를 이 책의 기준으로 점검하고, 어떤 설계가 토큰을 줄이며 어떤 부분이 다음 개선 후보인지 살펴본다.
